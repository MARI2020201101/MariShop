			...
			<input type="hidden" name="currPage">
				<nav aria-label="Page navigation">
					<ul class="pagination justify-content-end">
						<li class="page-item ${pageObject.prevPage? "":"disabled" }">
						<a class="page-link" href="${pageObject.currPage-1 }">Previous</a></li>
						...
						<a class="page-link" href="${pageObject.currPage+1 }">Next</a>
						</li>
					</ul>
				</nav>
		</form>
